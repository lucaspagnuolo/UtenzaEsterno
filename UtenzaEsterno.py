...
if funzionalita == "Gestione Creazione Utenze":
    ...
    # Se esterno, chiedi subito il tipo di esterno
    if tipo_utente == "Esterno":
        dipendente_esterno = st.selectbox("Tipo di Esterno:", ["Consulente", "Somministrato/Stage"], key="tipo_esterno")
    else:
        dipendente_esterno = None
    ...
    # Configurazioni specifiche per Dipendente Consip
    if tipo_utente == "Dipendente Consip":
        ...
        if dipendente_esterno == "Consulente":
        ...
        # Gestione email per consulenti esterni
        email_flag = False
        email = ""
        if dipendente_esterno == "Consulente":
    ...
    if st.button("Genera CSV"):
        ...
        mail = email if (esterno and dipendente_esterno == "Consulente" and not email_flag) else f"{sAMAccountName}@consip.it"
